...
function setProductDetails(productName, productPrice) {
  ...
  $("#productOriginalPrice").html("Original Price: " + "$"+(parseInt(productPrice)/100).toFixed(2));
  $("#productSalePrice").html("Sale Price: " + "$" + (parseInt(ib_paymentSummary.value)/100).toFixed(2));
}
