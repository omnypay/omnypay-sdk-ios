...
/**
  The \code
  Basket
  \endcode represents an active shopping session, which includes product line items, discount offers, payment instrument selections, split tender details and loyalty points.
*/
...
/**
  The \code
  BasketReceipt
  \endcode represents a Payment receipt of active shopping session, which includes product line items, discount offers, selected payment instrument, final reconciled totals for selected payment instrument and loyalty redemption status.
*/
...
/**
  Type adopting \code
  OmnyPayEventDelegate
  \endcode protocol can be used to listen for callbacks that are delivered when any OmnyPay event occurs. All the callback functions are called on main queue. Delegate of \code
  OmnyPayEventListener
  \endcode must adopt this protocol.
*/
...
/**
  A delegate of \code
  OmnyPayEventDelegate
  \endcode type. All the event callbacks are delivered to this delegate instance.
*/
