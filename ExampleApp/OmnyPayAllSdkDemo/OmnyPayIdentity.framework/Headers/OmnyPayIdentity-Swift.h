...
/// A read-only property to get an IdentityDocumentType configured to be scanned.
...
/// A convenience initializer that initializes IdentityConfig from another identityConfig object
///
/// \param config A <code>IdentityConfig
/// </code> object
///
/// \returns  An instance of <code>IdentityConfig
/// </code>
...
/// An object of IdentityDocument represents the result of identity scan operation. This object contains details regarding the identity document that was scanned.
...
/// A read only IdentityDocumentType which represents the type of document that was scanned.
@property (nonatomic, readonly) enum IdentityDocumentType documentType;
@end
...
/// IdentityDocumentType represents the type of document to be scanned.
...
/// An object of IdentityResult represents the results of identity scan operation. This object contains a IdentityDocument value that contains the properties of the document scanned.It also contains an error if scanning fails.
SWIFT_CLASS("_TtC15OmnyPayIdentity14IdentityResult")
@interface IdentityResult : NSObject

/// IdentityDocument value that contains the properties of the document scanned.
...
///
/// This class provides a singleton instance that is initialized with a default configuration of <code>IdentityConfig
...
/// A shared instance of OmnyPayIdentity, initialized with default IdentityConfig
+ (OmnyPayIdentity * _Nonnull)shared;

/// A block that is called when scanning is completed. It takes a IdentityResult as parameter and returns nothing.
@property (nonatomic, copy) void (^ _Nullable documentDidScanHandler)(IdentityResult * _Nonnull);

/// Creates an instance of OmnyPayIdentity
///
/// \param configuration An object of <code>IdentityConfig
/// </code> type. If nothing is passed in this parameter default configuration is used.
///
/// \returns  An instance of <code>OmnyPayIdentity
/// </code>
- (nonnull instancetype)initWith:(IdentityConfig * _Nonnull)configuration OBJC_DESIGNATED_INITIALIZER;

/// Creates an instance of OmnyPayIdentity with default IdentityConfig.
///
/// \returns  An instance of <code>OmnyPayIdentity
/// </code>
...
- (void)dismissIdentityScanView:(BOOL)animated completion:(void (^ _Nullable)(void))completion;
@end
