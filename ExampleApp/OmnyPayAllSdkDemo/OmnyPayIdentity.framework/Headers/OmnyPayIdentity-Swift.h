...
/**
  A read-only property to get an \code
  IdentityDocumentType
  \endcode configured to be scanned.
*/
...
/**
  ...
  IdentityConfig
  \endcode from another identityConfig object
  \param config A \code
  IdentityConfig
  \endcode object
...
/**
  An object of \code
  IdentityDocument
  \endcode represents the result of identity scan operation. This object contains details regarding the identity document that was scanned.
*/
...
/**
  A read only \code
  IdentityDocumentType
  \endcode which represents the type of document that was scanned.
*/
@property (nonatomic, readonly) enum IdentityDocumentType documentType;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
/**
  \code
  IdentityDocumentType
  \endcode represents the type of document to be scanned.
*/
...
/**
  An object of \code
  IdentityResult
  \endcode represents the results of identity scan operation. This object contains a \code
  IdentityDocument
  \endcode value that contains the properties of the document scanned.It also contains an error if scanning fails.
*/
...
/**
  \code
  IdentityDocument
  \endcode value that contains the properties of the document scanned.
*/
