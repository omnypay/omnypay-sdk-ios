...
/**
  An object of \code
  PICard
  \endcode represents the result of card scan operation. This object contains details regarding the credit card that was scanned.
*/
...
/**
  ...
  PIScanConfig
  \endcode from another PIScanConfig object
  \param config A \code
  PIScanConfig
  \endcode object
...
/**
  An object of \code
  PIScanResult
  \endcode represents the results of card scan operation. This object contains a \code
  PICard
  \endcode value that contains the properties of the card scanned. It also contains an error if scanning fails.
*/
...
/**
  \code
  PICard
  \endcode object that contains the properties of the card scanned.
*/
